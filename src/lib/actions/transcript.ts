      ...
      messages: [
        {
          ...
          content: `You are analyzing a classroom discussion transcript. Your role is to capture key points while keeping the students' authentic voice:
                    ...
                    2. Only include points clearly present in the transcript
                    3. Keep the casual, natural way students express themselves
                    4. Never add points similar to existing ones
                    5. Combine related ideas from the same discussion thread
